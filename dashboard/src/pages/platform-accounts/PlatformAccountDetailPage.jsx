  ...
  return (
    <div className="page-container animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tight">تفاصيل حساب المنصة</h2>
          <p className="text-xs font-bold text-slate-400 mt-1">عرض البيانات المرتبطة بحساب المنصة</p>
        </div>
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <Section title="المعلومات الأساسية">
            ...
            <Field label="المنصة" value={row.platform?.nameAr || row.platform?.nameEn} />
            <Field label="اسم المستخدم" value={row.username} />
            <Field label="رقم الحساب" value={row.accountId} />
